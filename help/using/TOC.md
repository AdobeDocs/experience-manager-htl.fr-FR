...
user-guide-description: Pour les projets AEM traditionnels, utilisez le langage de modèle HTML (HTL) afin de créer un framework web au niveau de l’entreprise.
