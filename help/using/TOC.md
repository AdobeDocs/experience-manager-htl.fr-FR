...
user-guide-description: Pour les projets AEM traditionnels, utilisez le langage HTL (HTML Template Language) pour la création d’une structure web d’entreprise.
