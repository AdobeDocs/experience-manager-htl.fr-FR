...
Pour obtenir un exemple des bonnes pratiques d’utilisation de HTL dans un projet réel, consultez la rubrique [Composants principaux AEM.](https://experienceleague.adobe.com/fr/docs/experience-manager-core-components/using/introduction)
