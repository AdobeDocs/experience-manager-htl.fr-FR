...
Pour plus d’informations, consultez la `Sling` [documentation du moteur de script HTL](https://sling.apache.org/documentation/bundles/scripting/scripting-htl.html#passing-parameters-to-java-use-objects).
